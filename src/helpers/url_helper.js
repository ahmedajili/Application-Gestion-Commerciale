...
export const POST_REGISTER = "https://localhost:7103/api/User/register";
...
export const POST_LOGIN = "https://localhost:7103/api/User/login";
...
//Tiers
export const GET_TIERS = "https://localhost:7103/api/Tiers";

//CategoriesArticles
export const GET_CATEGORIES_ARTICLES = "https://localhost:7103/api/CategorieArticle";
export const ADD_NEW_CATEGORIE = "https://localhost:7103/api/CategorieArticle";
export const UPDATE_CATEGORIE = "https://localhost:7103/api/CategorieArticle";
export const DELETE_CATEGORIE = "https://localhost:7103/api/CategorieArticle";
