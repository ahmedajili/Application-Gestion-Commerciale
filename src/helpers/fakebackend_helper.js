...
// get Tiers
export const getTiers = () => api.get(url.GET_TIERS);

// get CategorieArticles
export const getCategoriesArticles = () => api.get(url.GET_CATEGORIES_ARTICLES);

// add CategorieArticles
export const addNewCategorie = categorie => api.create(url.ADD_NEW_CATEGORIE, categorie);

// update Categorie
export const updateCategorie = categorie => api.put(url.UPDATE_CATEGORIE + '/' + categorie.id, categorie);

// delete Categorie
export const deleteCategorie = idcategorie => api.delete(url.DELETE_CATEGORIE + '/' + idcategorie);
