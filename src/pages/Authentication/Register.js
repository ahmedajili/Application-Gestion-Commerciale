                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            <h5 className="text-primary">Création d'un nouveau compte</h5>
                                            ...
                                            <Form
                                                ...
                                                {success && success ? (
                                                    <>
                                                        ...
                                                        <Alert color="success">
                                                            Utilisateur ajouté avec succés. Redirection en cours vers la page de connexion...
                                                        </Alert>
                                                    </>
                                                ) : null}
                                              ...
                                              {/* <div className="mb-4">
                                                ...
                                                <div className="mt-4">
                                                    <button className="btn btn-success w-100" type="submit" disabled={loading}>{loading ? <Spinner size="sm" className='me-2'> Loading... </Spinner> : "Sign Up"}
                                                        </button>
                                                </div>
